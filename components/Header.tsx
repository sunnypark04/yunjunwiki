...
import { FiEdit2, FiMessageSquare, FiBriefcase, FiSearch, FiShuffle, FiUser } from 'react-icons/fi';
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex items-center">
            ...
            <div className="absolute right-2.5 flex items-center gap-2 text-gray-400">
              ...
              <span className="cursor-pointer hover:text-wiki-green transition-colors text-xs">→</span>
            </div>
          </div>
...
// 메뉴 링크용 유틸리티 컴포넌트
function MenuLink({ icon: Icon, label }: { icon: React.ElementType, label: string }) {
  return (
    <div className="flex items-center gap-1 cursor-pointer hover:text-white transition-colors">
