...
import { Section, SubSection, FnItem } from "../components/WikiLayout";
        ...
        <div className="w-full leading-relaxed border-t pt-10">
          ...
          >
            <SubSection id="2.1" prefix="2.1." title="학문적 행보">
              <p className="mb-4">
                ...
                이후 미국 University of Oregon(UO)으로 건너가 Alexandre Dossin
                교수 밑에서 박사 과정을 밟고 있다. 사실상 교수님의 "애제자" 일
                만큼 실력에 기반한 신뢰가 두텁다.
              </p>
              <p className="mb-4">
              ...
              <p className="mb-4">
                최근 시카고에서 열린 MTNA conference에서 northwest division
                1위를 차지하고 전국 결승 진출자에 오르는 쾌거를 이루었다.
              </p>
              <p>
                실 연주 실력은 두말하면 잔소리이고 음악사, 음악이론, 학교 내
                반주, 교회 반주, 리사이틀 콩쿨 등 자신의 커리어를 끊임없이
                차곡차곡 쌓아가는 중이다.
              </p>
            </SubSection>
            ...
            <SubSection id="2.2" prefix="2.2." title="교회 생활">
              <p className="mb-4">
                유진한인교회 찬양팀의 메인 반주자로 매주 섬기며 유진교회의
                심장이라고 할 수 있다.
              </p>
              <p className="mb-4">
            ...
            <SubSection id="2.3" prefix="2.3." title="취미 활동">
              <p className="mb-4">
                미술에 대한 깊은 조예, 꾸준한 런닝으로 다져진 체력을 모두 가지고
              ...
              <p className="mb-4">
                ...
                독서광의 면모를 보였다. 여름에 한국에 가면 오늘이 끝인 것처럼
                노는 얼라들과는 달리 교보문고에 꼬박꼬박 출석할 정도라고
                한다.{" "}
              </p>
              <p className="mb-4">
              ...
              <p>
                여행을 매우 좋아한다. 미국에 5년 거주하며 센프란시스코, 시애틀,
                시카고, 플로리다, 뉴욕, 케나다 등 다수의 지역으로 여행을 다녀온
          ...
          >
            <p className="mb-4">
              ...
              실력을 엿볼 수 있다. 본인 셀카보단 남찍사, 풍경 사진이 많은
              편이다.{" "}
            </p>
            <p className="mb-4">
              사실 mz 세대 못지 않은 트렌디함을 갖추면서도 (개인{" "}
              <a href="#" className="text-[#0275d8] hover:underline">
                인스타
              </a>
              ,{" "}
              <a href="#" className="text-[#0275d8] hover:underline">
            ...
            <p className="mb-4">
              ...
              건반을 내리칠 때 관객의 심장을 함께 내려치는 경향이 있다. 작은
              음들까지 섬세하게 터치하는 정교한 테크닉을 보유했으며 자신이
              연주하는 것과는 별개인 티칭도 이해하기 쉽게 논리적으로 알려주는
              실력자이다.{" "}
            </p>
            <p className="mb-4">
            ...
            <p>
              ...
              무려 3년 연애 두번, 1년 연애 두번을 했다. 현재는 연애를 쉬고
              있지만 주변에 결혼을 하기 시작하는 친구들을 보며 복잡한 감정을
              느끼는 듯 하다.
            </p>
          </Section>
          ...
          >
            ...
            <p className="mb-4">
              ...
              정시를 뚫은 실력파이다. 수시입시때 학원 선생님과 불미스러운 사건을
              겪고 정시 입시 준비 기간 3개월동안 매일 9시간씩 연습했다고 한다.
              입시곡 중 하나인 쇼팽 에튀드 10-8 햇빛은{" "}
              <a href="#" className="text-[#0275d8] hover:underline">
                윤준의 유튜브
              </a>
            ...
            <p className="mb-4">
              ...
              <del className="text-gray-400">
                {" "}
                그렇게 피복실에 있는 업라이트 피아노로 군생활 내내 피아노를
                연습할 수 있었다고 한다.
              </del>{" "}
          ...
          >
            <ul className="list-disc list-inside text-[#0275d8]">
              ...
              <li className="cursor-pointer hover:underline">ISFP</li>
            </ul>
          </Section>

          {/* 각주 영역 */}
          <footer className="mt-20 pt-6 pb-12 border-t-2 border-[#ccc] text-[14px] text-gray-800 leading-relaxed space-y-3">
            <div className="font-bold mb-4">각주</div>
            <FnItem num={1}>여기에 1번 각주 내용을 입력하세요.</FnItem>
          </footer>
        </div>
      </main>
    </div>
